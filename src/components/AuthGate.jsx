    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      ...
      <div className="bg-dark-700 border border-dark-500 rounded-2xl p-8 w-full max-w-sm shadow-2xl">
        ...
        <p className="text-gray-400 text-sm text-center mb-6">
          Sign in to save your tier list and get personalized recommendations.
        </p>

        <button
          onClick={handleGoogle}
          disabled={loading}
          className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl bg-white text-dark-900 font-semibold text-sm hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {loading ? (
            <svg className="animate-spin w-5 h-5 text-dark-900" fill="none" viewBox="0 0 24 24">
